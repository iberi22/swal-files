...
Implement **Real-time inotify Filesystem Watcher** (`feat-files-03`) for `swal-files` in `swal-files-core`.
...
- `crates/swal-files-core/src/watcher.rs`
...
- [ ] Implement all structs, methods, and functions required for `Real-time inotify Filesystem Watcher`.
