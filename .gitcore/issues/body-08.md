...
Implement **Unified & Side-by-Side Git Diff Parser** (`feat-files-08`) for `swal-files` in `swal-files-git`.
...
- `crates/swal-files-git/src/diff.rs`
...
- [ ] Implement all structs, methods, and functions required for `Unified & Side-by-Side Git Diff Parser`.
