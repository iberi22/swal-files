...
Implement **Declarative JSON Configuration Engine** (`feat-files-04`) for `swal-files` in `swal-files-core`.
...
- `crates/swal-files-core/src/config.rs`
...
- [ ] Implement all structs, methods, and functions required for `Declarative JSON Configuration Engine`.
