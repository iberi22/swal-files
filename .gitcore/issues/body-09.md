...
Implement **Git Stage Operator & Commit Builder** (`feat-files-09`) for `swal-files` in `swal-files-git`.
...
- `crates/swal-files-git/src/commit.rs`
- `crates/swal-files-git/src/lib.rs`
...
- [ ] Implement all structs, methods, and functions required for `Git Stage Operator & Commit Builder`.
