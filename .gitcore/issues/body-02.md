...
Implement **Async Directory Scanner & Sorter** (`feat-files-02`) for `swal-files` in `swal-files-core`.
...
- `crates/swal-files-core/src/scanner.rs`
...
- [ ] Implement all structs, methods, and functions required for `Async Directory Scanner & Sorter`.
