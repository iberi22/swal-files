...
Implement **Core File Entry Types & Metadata Contract** (`feat-files-01`) for `swal-files` in `swal-files-core`.
...
- `crates/swal-files-core/src/types.rs`
- `crates/swal-files-core/Cargo.toml`
...
- [ ] Implement all structs, methods, and functions required for `Core File Entry Types & Metadata Contract`.
