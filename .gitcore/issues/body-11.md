...
Implement **QuickLook Markdown Parser & Formatter** (`feat-files-11`) for `swal-files` in `swal-files-preview`.
...
- `crates/swal-files-preview/src/markdown.rs`
...
- [ ] Implement all structs, methods, and functions required for `QuickLook Markdown Parser & Formatter`.
