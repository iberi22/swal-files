...
Implement **Git Working Tree Status Reader** (`feat-files-07`) for `swal-files` in `swal-files-git`.
...
- `crates/swal-files-git/src/status.rs`
...
- [ ] Implement all structs, methods, and functions required for `Git Working Tree Status Reader`.
